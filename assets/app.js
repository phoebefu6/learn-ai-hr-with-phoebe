...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    var m = mx || crumb.textContent.match(/HR session (\d+) of 10/);
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = mx
        ? ["a1-people-function.html", "a2-legal-map.html",
           "a3-governing-ai-hiring.html", "a4-fairness-in-practice.html",
           "a5-people-data.html", "a6-rollout-to-hr.html"]
        : ["b1-hr-workspace.html", "b2-role-and-jd.html", "b3-sourcing-outreach.html",
           "b4-screening-simulator.html", "b5-structured-interviews.html",
           "b6-offers-decision-record.html", "b7-onboarding.html",
           "b8-performance-feedback.html", "b9-ld-mobility.html", "b10-capstone-hiring-wave.html"];
